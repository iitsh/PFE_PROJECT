 ...
 *
 * >>> Note : ce fichier s'appelle Page_import_cv.test.jsx mais teste Page_nouveau_cv
 *     (même contenu que Page_nouveau_cv.test.jsx). L'étape d'import PDF est incluse
 *     dans le workflow testé de Page_nouveau_cv.
 */
